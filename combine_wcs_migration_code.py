#!/usr/bin/env python3
"""
Helper script to combine all WCS Data Migration Python source code into a single well-formatted markdown file.
This creates a comprehensive documentation file with all Python source code organized by module.
"""
...
class WCSMigrationCodeCombiner:
    def __init__(self, root_dir, output_file="wcs_migration_source_code.md"):
    ...
    def generate_toc(self, files):
        ...
        toc_lines = ["# WCS Data Migration Source Code Documentation\n", ""]
    ...
    def combine_files(self):
        ...
        content_lines.extend(
            [
                "# WCS Data Migration Source Code Documentation\n",
...
def main():
    ...
    combiner = WCSMigrationCodeCombiner(migration_dir)
