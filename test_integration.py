...
from converter.tools.command_line_tool import CommandLineTool, GodotTool, GdUnit4Tool
...
def test_command_line_tool():
    ...
    print(f"Command result: return_code={result.return_code}, stdout='{result.stdout}', stderr='{result.stderr}', timed_out={result.timed_out}")
...
def test_test_quality_gate():
    """Test the TestQualityGate implementation."""
    print("Testing TestQualityGate...")
    ...
    print("TestQualityGate test passed!")
