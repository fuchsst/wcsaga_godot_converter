...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test Runner for Wing Commander Saga to Godot Converter")
    parser.add_argument("module", nargs="?", help="Specific test module to run (without 'test_' prefix)")
