...
def register_converter_services(wcs_source_dir: Path, godot_target_dir: Path) -> None:
    ...
    container.register_factory('asset_catalog', 
                              lambda: AssetCatalog(godot_target_dir / "asset_catalog.db"))
    ...
    container.register_factory('ship_converter', 
                              lambda: RefactoredShipConverter(wcs_source_dir, godot_target_dir))
    container.register_factory('weapon_converter', 
                              lambda: WeaponTableConverter(wcs_source_dir, godot_target_dir))
    container.register_factory('armor_converter', 
                              lambda: ArmorTableConverter(wcs_source_dir, godot_target_dir))
    ...
    container.register_factory('ship_strategy', 
                              lambda: ShipTableStrategy(wcs_source_dir, godot_target_dir))
