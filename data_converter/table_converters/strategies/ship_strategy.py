...
class ShipTableStrategy(BaseTableStrategy):
                ...
                if line.startswith("#Ship Classes") or line.startswith("$Name:"):
                    ...
                    if ship_data:
                        ...
                        if self._create_ship_resource(ship_data, table_file):
                            ...
                            self.logger.warning(f"Failed to create resource for ship: {ship_data.name}")
    ...
    def _create_ship_resource(self, ship_data: ShipClassData, source_file: Path) -> bool:
        ...
        try:
            ...
            success = self._create_resource_file(resource_content, resource_filename, "ships")
            ...
            self.logger.error(f"Failed to create ship resource for {ship_data.name}: {e}")
            return False
...
"""
    ...
    def _create_resource_file(self, content: str, filename: str, subdirectory: str) -> bool:
        """
