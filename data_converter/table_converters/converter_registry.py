...
class ConverterRegistry:
    ...
    @classmethod
    def create_converter(cls, table_type: TableType, source_dir: Path, target_dir: Path) -> BaseTableConverter:
        """
    ...
    @classmethod
    def get_converter_for_file(cls, table_file: Path, source_dir: Path, target_dir: Path) -> Optional[BaseTableConverter]:
        """
...
def auto_register_converters() -> None:
    ...
    converter_files = [f for f in os.listdir(current_dir) 
    ...
    for converter_file in converter_files:
        ...
        try:
            ...
            module = __import__(f'data_converter.table_converters.{module_name}', fromlist=['*'])
