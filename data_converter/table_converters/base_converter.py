...
class BaseTableConverter(IFileConverter, IValidatableConverter):
    ...
    def convert_table_file(self, table_path: Path, output_path: Optional[Path] = None) -> bool:
        """
    ...
    def can_convert(self, file_path: Path) -> bool:
        ...
        expected_type = self.TABLE_TYPE.value if self.TABLE_TYPE != TableType.UNKNOWN else None
