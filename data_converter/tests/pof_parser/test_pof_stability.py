...
class TestBSPNodeStructure(unittest.TestCase):
    ...
    def test_bsp_node_creation(self):
        ...
        # Test empty node
        empty_node = BSPNode(
            node_type=BSPNodeType.EMPTY, normal=Vector3D(0, 0, 1), plane_distance=0.0
        )
...
class TestBSPParsingRobustness(unittest.TestCase):
    ...
    def test_invalid_chunk_size(self):
        ...
        malformed_data = struct.pack(
            "<II", 1, 1000
        )  # chunk type 1 (DEFFPOINTS), size 1000
    ...
    def test_invalid_vertex_index(self):
        ...
        )  # vertex indices (1 and 2 are invalid)
