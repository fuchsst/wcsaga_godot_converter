...
from data_converter.pof_parser.pof_data_extractor import POFDataExtractor, POFModelData
from data_converter.pof_parser.pof_error_handler import POFErrorHandler, ErrorSeverity, ErrorCategory
...
from data_converter.pof_parser.validation_system import POFValidator, validate_pof_model, ValidationResult
...
class TestValidationSystem(unittest.TestCase):
    ...
    def create_test_model_data(self) -> Dict:
        ...
        from data_converter.pof_parser.pof_enhanced_types import POFModelData, POFHeader, POFVersion
