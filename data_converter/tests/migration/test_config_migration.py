...
"""
    ...
    def test_graphics_settings_structure(self):
        ...
        self.assertEqual(
            godot_settings["display/window/vsync/vsync_mode"], 1
        )  # VSync on
    ...
    def test_migration_report_generation(self):
        ...
        migrator.control_bindings = [
            ControlBinding(
                "TARGET_NEXT", 0, 20, 0, description="Target Next", category="targeting"
            ),
            ControlBinding(
                "FIRE_PRIMARY",
                15,
    ...
    def test_complete_migration_process(self):
        ...
        success = migrator.migrate_wcs_configuration(
            wcs_source_dir=self.wcs_source_dir, godot_target_dir=self.godot_target_dir
        )
