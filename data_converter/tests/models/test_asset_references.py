...
def test_model_asset_creation():
    ...
    assert not pof_asset.is_cockpit
    assert not pof_asset.is_target
...
def test_visual_effect_asset_creation():
    ...
    effect_asset = VisualEffectAsset(
        file_path="explosion_effect", effect_type="explosion"
    )
...
def test_ship_asset_collection_from_registry():
    ...
    asset_registry = [
        {"property": "pof_file", "asset_path": "test_ship.pof", "asset_type": "model"},
        {
            "property": "cockpit_pof_file",
            "asset_path": "test_cockpit.pof",
            "asset_type": "model",
        },
        {"property": "engine_sound", "asset_path": "engine.wav", "asset_type": "audio"},
        {
