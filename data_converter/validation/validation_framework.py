...
class ValidationFramework:
    ...
    def validate_all(self) -> Dict[str, List[str]]:
        ...
        logger.info(f"Validation complete - Errors: {error_count}, Warnings: {warning_count}, Info: {info_count}")
    ...
    def _validate_media_files(self) -> None:
        ...
        media_extensions = {".png", ".jpg", ".jpeg", ".webp", ".ogg", ".wav", ".glb", ".gltf"}
        media_files = [
    ...
    def generate_validation_report(self, output_file: Optional[Path] = None) -> str:
        ...
        if self.validation_results["info"]:
            ...
            if info_count > display_count:
                report_lines.append(f"  ... and {info_count - display_count} more info messages")
            report_lines.append("")
