...
class MissionEventConverter:
    ...
    def _convert_single_event(
        self, event: MissionEvent, event_name: str
    ) -> Optional[ConvertedEvent]:
        ...
        try:
            ...
            trigger_conditions, actions = self._extract_conditions_and_actions(
                sexp_tree
            )
    ...
    def _convert_goal_to_event(
        self, goal: MissionGoal, goal_name: str
    ) -> Optional[ConvertedEvent]:
    ...
    def _parse_sexp_tokens(
        self, tokens: List[str], index: int
    ) -> Tuple[Optional[SexpNode], int]:
    ...
    def _extract_conditions_and_actions(
        self, sexp_tree: SexpNode
    ...
    def _extract_from_node(
        self, node: SexpNode, conditions: List[str], actions: List[str]
    ) -> None:
    ...
    def _generate_event_function(
        self, function_name: str, condition: str, event: MissionEvent
    ) -> str:
...
'''
    ...
    def _generate_goal_function(
        self, function_name: str, condition: str, goal: MissionGoal
    ) -> str:
...
'''
    ...
    def generate_mission_event_system(
        self, converted_events: Dict[str, ConvertedEvent]
    ) -> str:
