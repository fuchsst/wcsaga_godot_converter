...
class IntegrationOrchestrator:
    ...
    def _create_file_structure(self) -> bool:
        ...
        try:
            ...
            if not self.file_structure_creator.create_asset_directories(self.asset_mappings):
                return False
...
"""
            ...
            ship_scene_path = project_root / "entities" / "fighters" / "confed" / "fighters" / "rapier" / "rapier.tscn"
...
def main():
    ...
    parser.add_argument("--output", required=True, help="Output directory for Godot project")
    parser.add_argument("--project-name", default="wcs_godot", help="Name of Godot project")
    ...
    if success:
        print(f"Conversion pipeline completed successfully!")
